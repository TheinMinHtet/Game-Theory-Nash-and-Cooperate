...
def create_base_graph() -> nx.DiGraph:
    ...
    """
    G = nx.DiGraph()
    G.add_node("A", pos=(300, 350))
    G.add_node("B", pos=(550, 150)) 
    G.add_node("C", pos=(550, 550)) 
    G.add_node("D", pos=(800, 350))
    ...
    G.add_edge("A", "C", cost=(0.2, 10.0), original_cost_fn=lambda x: (x * 0.2) + 15.0)
    G.add_edge("C", "D", cost=(0.2, 10.0), original_cost_fn=lambda x: (x * 0.2) + 15.0)
